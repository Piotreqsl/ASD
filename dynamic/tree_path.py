...
## zero, nie bierzemy nic i chuj
## v.val bieremy tylko to
## bierzemy tylko to i max z lewego
## bierzemy tylko to i max z prawego
## ml i mr - mozemy nie zaczynać w roocie np
