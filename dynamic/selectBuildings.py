## F[i][j] - ilosc studentów w i początkowych budynkach za minimalną j cene
...
def select_buildings(T, MaxP):
    ...
    ## F[i][j] maksymalna liczba studentów w i blokach za j cenę
